...
public class MainActivity extends Activity {
    ...
    LinearLayout layout_block , layout_panchayat;
    Spinner district_spinner , block_spinner , panchayat_spinner;
    EditText name_edit_text , pincode_eddit_text;
  ...
  private void initialize_components(){
      ...
      panchayat_spinner = (Spinner)findViewById(R.id.panchayat_sp);
      layout_block = (LinearLayout)findViewById(R.id.layout_block);
      layout_panchayat = (LinearLayout)findViewById(R.id.layout_panchayat);
